    ...
    <div className="totals">
      ...
      <div className="totals__content">
        <div className="totals-data">
          {" "}
          <p className="chart-legend__text"> Total balances in currency:</p>
        ...
        <div className="totals-data">
          ...
          <div className="chart-legend__totals">{numWithDefaultImage}</div>
        ...
        <div className="totals-data">
          ...
          <div className="chart-legend__totals">{numWithZeroBalance}</div>
        ...
        <div className="totals-data">
          ...
          <div className="chart-legend__totals">{numWithPositiveBalance}</div>
        ...
        <div className="totals-data">
          ...
          <div className="chart-legend__totals">{numWithNegativeBalance}</div>
